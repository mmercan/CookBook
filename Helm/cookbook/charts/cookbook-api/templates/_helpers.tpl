...
*/}}
{{- define "cookbook-api.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "cookbook-api.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
